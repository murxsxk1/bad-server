...
// Helper функция для санитизации комментариев (защита от XSS)
const sanitizeComment = (comment: string | undefined): string => {
  if (!comment) return ''
...
export const getOrders = async (
  ...
  try {
    ...
    // Защита от NoSQL-инъекций в фильтре status
    if (status) {
